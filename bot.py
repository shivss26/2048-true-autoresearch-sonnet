...
def choose_move(board, score):
    ...
    for direction in valid:
        ...
        # Board quality (reduced weight to prioritize score-seeking over structure)
            ...
            for next_dir in next_valid:
                ...
                if next_next_valid:
                    ...
                    for third_dir in next_next_valid:
                        ...
                        best_third = max(best_third, third_score + evaluate_board(third_board) * 0.2)
                    cont_value += best_third * 0.6

                best_continuation = max(best_continuation, cont_value)

            value += best_continuation * 0.6
